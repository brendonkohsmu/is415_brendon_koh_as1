...
minResolution:0.280044661523,
 maxResolution:70.0111653807,
            ...
            });var format_OSMExtract_railways7 = new ol.format.GeoJSON();
var features_OSMExtract_railways7 = format_OSMExtract_railways7.readFeatures(geojson_OSMExtract_railways7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_OSMExtract_railways7 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_OSMExtract_railways7.addFeatures(features_OSMExtract_railways7);var lyr_OSMExtract_railways7 = new ol.layer.Vector({
                source:jsonSource_OSMExtract_railways7, 
                style: style_OSMExtract_railways7,
                title: "OSM-Extract_railways"
            });var lyr_Elderly_Heatmap8 = new ol.layer.Image({
                            opacity: 1,
                            title: "Elderly_Heatmap",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/Elderly_Heatmap8.png",
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
...
lyr_OSMExtract_railways7.set('fieldImages', {'osm_id': 'TextEdit', 'name': 'TextEdit', 'type': 'TextEdit', 'MRT_Lines_LINE_COLOUR': 'TextEdit', });
lyr_DistributionofPopulationByAge65andAbove0.set('fieldLabels', {'OBJECTID': 'no label', 'SUBZONE_NO': 'no label', 'SUBZONE_N': 'no label', 'SUBZONE_C': 'no label', 'CA_IND': 'no label', 'PLN_AREA_N': 'no label', 'PLN_AREA_C': 'no label', 'REGION_N': 'no label', 'REGION_C': 'no label', 'INC_CRC': 'no label', 'FMEL_UPD_D': 'no label', 'X_ADDR': 'no label', 'Y_ADDR': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', 'PopDen': 'no label', 'AgeGroup2015_ZONE_N': 'no label', 'AgeGroup2015_ZONE_C': 'no label', 'AgeGroup2015_SUB_ZONE_C': 'no label', 'AgeGroup2015_ALL_AGE': 'no label', 'AgeGroup2015_AGE0-4': 'no label', 'AgeGroup2015_AGE5-9': 'no label', 'AgeGroup2015_AGE10-14': 'no label', 'AgeGroup2015_AGE15-19': 'no label', 'AgeGroup2015_AGE20-24': 'no label', 'AgeGroup2015_AGE25-29': 'no label', 'AgeGroup2015_AGE30-34': 'no label', 'AgeGroup2015_AGE35-39': 'no label', 'AgeGroup2015_AGE40-44': 'no label', 'AgeGroup2015_AGE45-49': 'no label', 'AgeGroup2015_AGE50-54': 'no label', 'AgeGroup2015_AGE55-59': 'no label', 'AgeGroup2015_AGE60-64': 'no label', 'AgeGroup2015_AGE65-69': 'no label', 'AgeGroup2015_AGE70-74': 'no label', 'AgeGroup2015_AGE75-79': 'no label', 'AgeGroup2015_AGE80-84': 'no label', 'AgeGroup2015_AGE85': 'no label', 'AgeGroup2015_AGE_ELDERLY': 'no label', });
...
lyr_OSMExtract_railways7.set('fieldLabels', {'osm_id': 'no label', 'name': 'no label', 'type': 'no label', 'MRT_Lines_LINE_COLOUR': 'no label', });
lyr_OSMExtract_railways7.on('precompose', function(evt) {
