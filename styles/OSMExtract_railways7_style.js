var size = 0;
function categories_OSMExtract_railways7(feature, value) {
...
case 'YELLOW':
        ...
        stroke: new ol.style.Stroke({color: 'rgba(255,255,74,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3}),
                    ...
                    break;}};
var styleCache_OSMExtract_railways7={}
var style_OSMExtract_railways7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("MRT_Lines_LINE_COLOUR");
    var style = categories_OSMExtract_railways7(feature, value);
    if ("" !== null) {
    ...
    if (!styleCache_OSMExtract_railways7[key]){
        ...
        styleCache_OSMExtract_railways7[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_OSMExtract_railways7[key]];
